...
'rateAddJet', 'pressureJet', 'yieldJet', 'yieldSmall', 'yieldBig', 'makeEtc','sizeSem','tIgl','pcuR','analysisEtc');

$query = 'SELECT * FROM analysispwmass_reaction_view';
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div data-column="etc">' . $row["analysisEtc"] . '</div>';
