...
if ($_SESSION['role_id']<3){
 ...
 if(!empty($_POST))
 {
      ...
      {
           $query = "INSERT INTO analysispwtbl (sampleNo, d10, d50, d90, dmax, tIgl, pIgl, cIgl, dtaPeak, enthalphy, bet, td)
           VALUES('$sampleNo', '$d10', '$d50', '$d90', '$dmax', '$tIgl', '$pIgl', '$cIgl', '$dtaPeak', '$enthalphy', '$bet', '$td');
           ";
